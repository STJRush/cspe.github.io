...
<p style="color:white;">Rights & Responsibilities
...
<p style="color:white;">Human Dignity
...
<p style="color:white;">Stewardship
...
<p style="color:white;">Development
...
<p style="color:white;">Interdependence
...
<p style="color:white;">A total of 40% of the marks in the exam are awarded for a written theory test, which includes such things as producing a poster, letter or article on a CSPE topic (such as poverty, racism, discrimination, etc.) and interpreting opinion polls.The written exam also has a number of short questions

<p style="color:white;">The remaining 60% of the marks are given for a report on an Action Project performed by an entire class of students at a time. This has to be based on one of the core topics - e.g. workers rights, environmentalism, racism, human rights, etc
</body>
</html>
